...
module.exports.createComment = async(req, res) => {  // 부모댓글
...
module.exports.createReply = async(req, res) => { // 대댓글
...
module.exports.modifyComment = async(req, res) => { // 댓글 수정
...
module.exports.deleteComment = async(req, res) => {  // 댓글 삭제
...
module.exports.likeComment = async(req, res) => {  // 댓글 좋아요.
    const { id ,commentId } = req.params;
    if(req.user) {
