...
module.exports.renderForgotPwdPage = (req, res) => {
    res.render('users/forgotPwd');
};

module.exports.renderCheckUserPage = async (req, res) => {
    res.render('users/checkuser');
};

module.exports.renderModifyUserInfoPage = async(req, res) => {
...
module.exports.submitWithdrawalCode = async(req, res) => {  
...
module.exports.withdrawUser = async(req, res) => {
...
module.exports.modifyUserInfo = async(req, res) => {
...
module.exports.sendTempPwd = async(req, res) => {
...
module.exports.checkEmailNickname = async(req, res) => { 
...
module.exports.sendSignUpCode = async(req, res) => {
...
module.exports.submitSignUpCode = async(req, res) => {
...
module.exports.renserSignInPage = (req, res) => {
