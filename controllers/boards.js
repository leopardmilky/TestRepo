...
module.exports.createPost = async(req, res) => {    // 게시물 등록하기
...
module.exports.likePost = async(req, res) => {  // 게시물 좋아요.
    const { id } = req.params;
    if(req.user){
...
module.exports.reportPost = async(req, res) => {    // 게시물 신고
    const {id} = req.params;
    if(req.user) {
...
module.exports.renderEditForm = async(req, res) => { // 게시물 수정하기 페이지
    const {id} = req.params;
...
module.exports.modifyPost = async(req, res) => {  // 게시물 수정하기
    const { id } = req.params;
    const board = await Board.findById(id);
...
module.exports.deletePost = async(req, res) => { // 게시물 삭제
    const {id} = req.params;
    const board = await Board.findById(id);
